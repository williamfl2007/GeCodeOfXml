...
module GeCodeOfXml  
  class Base
    ...
    def initialize (env)
      ...
      ignore_tables = File.open("vendor/plugins/GeCodeOfXml/config/ignore.yml").collect { |e| e.chomp }
  ...
  class Utilities
    ...
    # 
    # == Exemplo
    # script/generate GeCodeOfXml development style:depot
